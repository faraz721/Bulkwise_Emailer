...
def preview():
    ...
    return render_template('preview.html', sender=sender_email, subject=subject, message=message_template, recipients=recipients_dict.values(), attachment=attachment_name)
...
def send():
    ...
    return render_template('result.html', sender=sender_email, recipients=[r['email'] for r in recipients], subject=subject, message=message_template, attachment=attachment_name, results=results)
